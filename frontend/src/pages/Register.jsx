...
import { UserPlus, Mail, Lock, AlertCircle, Cpu } from 'lucide-react'
    ...
    <div className="min-h-screen flex items-center justify-center px-4 animate-fade-in">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-secondary to-pink-600 rounded-2xl mb-6 shadow-xl shadow-secondary/30 transform hover:scale-110 transition-transform duration-300">
            <Cpu className="text-white" size={40} />
          </div>
          <h1 className="text-4xl font-bold text-white mb-2 tracking-tight">Get Started</h1>
          <p className="text-gray-400">Join the gamified habit revolution</p>
        </div>
